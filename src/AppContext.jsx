  ...
  const fetchTestData = async (patient_uid, transaction_id) => {
    ...
    try {
      ...
      setTestData({
        ...
        joint_attention_error: data['Joint Attention Social'] || '',
        eye_contact_error: data['Eye Contact Error'] || '',
        gaze_dispersion: data['Gaze Dispersion'] || '',
        gaze_speed: data['Gaze Speed'] || '',
        screen_focus: data['Screen Focus'] || '',
        object_tracking_error: data['Object Tracking'] || '',
        social_preference: data['Social Preference'] || '',
        gaze_holds: data['Gaze Hold'] || '',
        saccades: data['Saccades'] || '',
        lipsync_recog: data['Lipsync'] || '',
        convo_recog: data['Conversation Recognition'] || '',
        yaw: data['Yaw'] || '',
        pitch: data['Pitch'] || '',
        roll: data['Roll'] || '',
